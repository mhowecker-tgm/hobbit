#ifndef HOBBIT_UPPER_BODY_TRACKER_DATA_STRUCTURES_H_INCLUDED
#define HOBBIT_UPPER_BODY_TRACKER_DATA_STRUCTURES_H_INCLUDED
...
static void updateSkeletonBoundingBox(struct skeletonHuman * sk)
{
  ...
  unsigned int i=0;
     ...
     //fprintf(stderr,"BBoxSize(%0.2f,%0.2f,%0.2f)\n", sk->bboxDimensions.x  , sk->bboxDimensions.y , sk->bboxDimensions.z );
}
