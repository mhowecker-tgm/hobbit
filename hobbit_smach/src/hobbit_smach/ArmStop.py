...
class ArmActionClient():
	...
	# listening for goals.
	print "ArmActionClient: does NNNNNOOOOOOOOOOOOOOOOTTTTTTTTTTTTTTTTTTT wait_for_server()"
...
if __name__ == '__main__':
    ...
    # Node name
    rospy.init_node('arm_action_client_arm_stop')
    print "node arm_action_client to stop arm"
    arm_client = ArmActionClient()
    cmd = String ("SetStopArmMove")
