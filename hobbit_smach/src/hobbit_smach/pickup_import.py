...
class DavidPickingUp(State):
    ...
    def isGraspableObject(self):
        ...
        logging.do_log_data("5315ODSGP Object Data per Segmented Object (grasppos): " + "Object center in RCS: "+ str(pnt_rcs) + "Number points of segmented objects: " + str(self.pc.height*self.pc.width))
