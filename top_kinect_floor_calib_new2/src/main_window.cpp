...
#include <QPainter>
#include <iostream>
#include "../include/TopKinectFloorCalib/main_window.hpp"
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
// Create the checkbox for showing/hiding the detected line.
  pLine = new QCheckBox(this);
  pLine->setGeometry(8, 208, MY_BUT_X, 32);

  pLabel = new QLabel(tr("Show line"), this);
  pLabel->setGeometry(40, 208, MY_BUT_X, 32);

  pMax = new QCheckBox(this);
  pMax->setGeometry(8, 248, MY_BUT_X, 32);

  pLabel2 = new QLabel(tr("0.0"), this);
  pLabel2->setGeometry(40, 248, MY_BUT_X, 32);
...
// Connect the signals and slots.
  ...
  QObject::connect(&qnode, SIGNAL(maxUpdated(double)), this, SLOT(updateMax(double)));
  QObject::connect(pLine, SIGNAL(clicked()), this, SLOT(lineRequest()));
  QObject::connect(pMax, SIGNAL(clicked()), this, SLOT(maxRequest()));
}
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
// Method invoked by draw events.
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
void MainWindow::updateMax(double Max)
{
  pLabel2->setNum(Max);
}
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
void MainWindow::lineRequest()
{
  printf("bShowLine: %i\n", pLine->isChecked());
  qnode.bShowLine = pLine->isChecked();
}
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
// Show or hide the line.
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
void MainWindow::maxRequest()
{
  printf("bShowMax: %i\n", pMax->isChecked());
  qnode.bShowMax = pMax->isChecked();
}
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
}
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
