...
#include <stdio.h>
#include <math.h>
#include "../include/TopKinectFloorCalib/qnode.hpp"
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
// Get the maximum disparity ever.
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
void QNode::GetMaxDisparity(float *pDisp)
{
  unsigned int u, LoopCtr;
  float a, f;

// Initialise the variables.
  LoopCtr = ImgWidth * ImgHeight;
  f = maxDisparity;
...
void QNode::disparityCallback(const stereo_msgs::DisparityImage::ConstPtr& msg)
{
  ...
  if (bRun)
  {
    ...
    if (bShowMax) GetMaxDisparity(pInDisp);
...
//    printf("y = %f * x + %f\n", k, d);
    ...
    Q_EMIT imageUpdated();
    if (bShowMax) Q_EMIT maxUpdated((double) maxDisparity);
  }
}
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
